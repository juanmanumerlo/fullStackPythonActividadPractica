...
--
-- Host: localhost    Database: db_recetazos
-- ------------------------------------------------------
...
CREATE TABLE `categoria_recetas` (
  ...
  `nombre` varchar(20) DEFAULT 'Sin Categoria',
...
INSERT INTO `categoria_recetas` VALUES (1,'Sin Categoria'),(2,'Entradas');
...
-- Dump completed on 2022-11-01 20:37:56
